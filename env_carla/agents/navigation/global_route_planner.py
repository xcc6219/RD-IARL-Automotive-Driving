...
"""
GlobalRoutePlanner implementation using A* search over the CARLA map topology.
"""
...
class GlobalRoutePlanner(object):
    """Provides high-level route planning over the CARLA road network."""
    ...
    def setup(self):
        """Build graph representation from server topology data."""
    ...
    def abstract_route_plan(self, origin, destination):
        """Generate a turn-by-turn route plan."""
    ...
    def trace_route(self, origin, destination):
        """Return a list of (carla.Waypoint, RoadOption) from origin to destination."""
        route_trace = []
        route = self._path_search(origin, destination)
