...
Loads model weights from the ``model_weight/`` directory, runs a configurable
    ...
    try:
        for i in range(param.test_iteration):
            ...
            while True:
                ...
                if done:
                    route_completion = min(carla_env.total_distance / 750, 1.0)
...
if __name__ == '__main__':
    ...
    # CARLA environment
    parser.add_argument('--map', type=str, default='Town03')
    parser.add_argument('--task_mode', type=str, default='roundabout')
    ...
    # model weights
    parser.add_argument('--load_dir', type=str, default='./model_weight')
